    ...
    while(true) {
        ...
        while(oin.recv(msg)) {
            ...
            if (address == "/theia1"){
                ...
                getSmoothedDistance(1) => slowStates[0];
...
fun void triggerAll(int maxDelay) {
    ...
    for (int t; t < 6; t++){
        for (int i; i < 6; i++){
            spork ~ gods1(i+60, 50, 30);
            spork ~ gods2(i+60, 10, 30);
            spork ~ gods3(i+60, 10, 30);
        }   
    }
...
fun void triggerAllRhythmic(int maxDelay) {
    (maxDelay / 6) $ int => int delay;
    for (int i; i < 6; i++){
        spork ~ gods1(i+60, 20, 30);
        spork ~ gods2(i+60, 10, 30);
        spork ~ gods3(i+60, 5, 30);      
    }   
    delay::ms => now; 
}
...
fun void productive1(int delayTime){
    ...
    for (int i; i < 6; i++){
        ...
        // trigger two durring the 'main' section
            ...
            spork ~ gods1(i+60,  4, 30);
            spork ~ gods2(i+60, 30, 20);
        }
        // trigger them all at the 'outro'
        else {
            spork ~ gods1(i+60,  4, 30);
            spork ~ gods2(i+60, 50, 20);
            spork ~ gods3(i+60, 20, 40);            
        }
...
fun void productive2(int delayTime){
    ...
    for (int i; i < 6; i++){
        ...
        if (Math.random2(0, 10) < 4){
            spork ~ gods3(Math.random2(0,6)+60, 15, 30);
        }
        if (Math.random2(0,10) < 5) {
            spork ~ gods2(Math.random2(0,6)+60, 15, 30);   
        }
        if (Math.random2(0,10) < 5) {
            spork ~ gods1(Math.random2(0,6)+60, 15, 30);   
        }
